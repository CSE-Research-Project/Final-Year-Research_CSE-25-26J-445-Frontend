...
export function getPopularCompanies(): CseCompany[] {
    return [
        CSE_COMPANIES.find(c => c.symbol === "ACL.N0000")!,
        CSE_COMPANIES.find(c => c.symbol === "ASIR.N0000")!,
        CSE_COMPANIES.find(c => c.symbol === "CERA.N0000")!,
        CSE_COMPANIES.find(c => c.symbol === "DIAL.N0000")!,
        CSE_COMPANIES.find(c => c.symbol === "DIMO.N0000")!,
        CSE_COMPANIES.find(c => c.symbol === "CIC.N0000")!,
        CSE_COMPANIES.find(c => c.symbol === "DIPD.N0000")!,
        CSE_COMPANIES.find(c => c.symbol === "DIST.N0000")!,
        CSE_COMPANIES.find(c => c.symbol === "DPL.N0000")!,
        CSE_COMPANIES.find(c => c.symbol === "HAYL.N0000")!,
        CSE_COMPANIES.find(c => c.symbol === "LALU.N0000")!,
        CSE_COMPANIES.find(c => c.symbol === "LCEY.N0000")!,
        CSE_COMPANIES.find(c => c.symbol === "LION.N0000")!,
        CSE_COMPANIES.find(c => c.symbol === "LITE.N0000")!,
        CSE_COMPANIES.find(c => c.symbol === "LMF.N0000")!,
        CSE_COMPANIES.find(c => c.symbol === "LOLC.N0000")!,
        CSE_COMPANIES.find(c => c.symbol === "LWL.N0000")!,
        CSE_COMPANIES.find(c => c.symbol === "RCL.N0000")!,
        CSE_COMPANIES.find(c => c.symbol === "RICH.N0000")!,
        CSE_COMPANIES.find(c => c.symbol === "SINS.N0000")!,
        CSE_COMPANIES.find(c => c.symbol === "SIRA.N0000")!,
        CSE_COMPANIES.find(c => c.symbol === "TILE.N0000")!,
        CSE_COMPANIES.find(c => c.symbol === "TJL.N0000")!,
        CSE_COMPANIES.find(c => c.symbol === "TPL.N0000")!,
    ].filter(Boolean)
}
